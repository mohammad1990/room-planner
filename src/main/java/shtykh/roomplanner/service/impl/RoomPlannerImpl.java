...
public class RoomPlannerImpl implements RoomPlanner {
    ...
    public RoomPlannerImpl(RoomStateService roomStateService) {
    ...
    public RoomPlan plan(List<Integer> roomRequest) {
        ...
        AvailabilityPlan availablePlan = roomStateService.getAvailableRooms();
        Map<RoomLevel, Integer> availableRooms = availablePlan.getValue();
        plan.setVersion(availablePlan.getVersion());
